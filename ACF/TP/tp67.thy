...
lemma Correction: "\<forall>t. (san1 stat) \<longrightarrow> \<not>(BAD (evalS stat t))"
nitpick
apply auto
oops

lemma Completude:"\<forall>t. \<not>(BAD (evalS stat t)) \<longrightarrow> (san1 stat)"
nitpick
apply auto
oops

lemma Correction: "\<forall>t. (san2 stat) \<longrightarrow> \<not>(BAD (evalS stat t))"
nitpick
apply auto
oops

lemma Completude:"\<forall>t. \<not>(BAD (evalS stat t)) \<longrightarrow> (san2 stat)"
nitpick
apply auto
oops
...
"san3 (Exec e) =  (if e = 0 then False else True)"
